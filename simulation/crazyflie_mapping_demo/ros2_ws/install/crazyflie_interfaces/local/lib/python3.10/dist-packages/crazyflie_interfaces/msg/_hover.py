    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'crazyflie_interfaces.msg.Hover')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hover
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hover
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hover
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hover
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hover
...
class Hover(metaclass=Metaclass_Hover):
    ...
    def z_distance(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'z_distance' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
