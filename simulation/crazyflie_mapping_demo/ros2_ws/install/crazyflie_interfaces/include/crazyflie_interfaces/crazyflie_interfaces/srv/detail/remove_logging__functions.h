...
#ifndef CRAZYFLIE_INTERFACES__SRV__DETAIL__REMOVE_LOGGING__FUNCTIONS_H_
#define CRAZYFLIE_INTERFACES__SRV__DETAIL__REMOVE_LOGGING__FUNCTIONS_H_
...
/// Initialize srv/RemoveLogging message.
/**
...
/// Finalize srv/RemoveLogging message.
/**
...
/// Create srv/RemoveLogging message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__RemoveLogging_Request__init().
...
/// Destroy srv/RemoveLogging message.
/**
 * It calls
 * crazyflie_interfaces__srv__RemoveLogging_Request__fini()
...
/// Check for srv/RemoveLogging message equality.
/**
...
/// Copy a srv/RemoveLogging message.
/**
...
/// Initialize array of srv/RemoveLogging messages.
/**
...
/// Finalize array of srv/RemoveLogging messages.
/**
 * It calls
 * crazyflie_interfaces__srv__RemoveLogging_Request__fini()
...
/// Create array of srv/RemoveLogging messages.
/**
 * It allocates the memory for the array and calls
 * crazyflie_interfaces__srv__RemoveLogging_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RemoveLogging messages.
/**
 * It calls
 * crazyflie_interfaces__srv__RemoveLogging_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RemoveLogging message array equality.
/**
...
/// Copy an array of srv/RemoveLogging messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__RemoveLogging_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__RemoveLogging_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It allocates the memory for the array and calls
 * crazyflie_interfaces__srv__RemoveLogging_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__RemoveLogging_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CRAZYFLIE_INTERFACES__SRV__DETAIL__REMOVE_LOGGING__FUNCTIONS_H_
