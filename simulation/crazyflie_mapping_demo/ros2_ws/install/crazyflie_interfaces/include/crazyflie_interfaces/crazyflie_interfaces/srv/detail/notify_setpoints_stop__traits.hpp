...
inline void to_flow_style_yaml(
  const NotifySetpointsStop_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: group_mask
  ...
  // member: remain_valid_millisecs
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.remain_valid_millisecs, out);
  }
  out << "}";
...
inline std::string to_yaml(const NotifySetpointsStop_Request & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const NotifySetpointsStop_Response & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const NotifySetpointsStop_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
