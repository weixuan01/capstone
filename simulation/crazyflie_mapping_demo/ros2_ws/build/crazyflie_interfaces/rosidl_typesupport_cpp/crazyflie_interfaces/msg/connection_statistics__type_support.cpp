...
static const _ConnectionStatistics_type_support_symbol_names_t _ConnectionStatistics_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_interfaces, msg, ConnectionStatistics)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, msg, ConnectionStatistics)),
  }
};
...
{
  return &::crazyflie_interfaces::msg::rosidl_typesupport_cpp::ConnectionStatistics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crazyflie_interfaces, msg, ConnectionStatistics)() {
  return get_message_type_support_handle<crazyflie_interfaces::msg::ConnectionStatistics>();
}
