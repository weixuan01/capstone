...
#ifndef CRAZYFLIE_INTERFACES__SRV__DETAIL__LAND__FUNCTIONS_H_
#define CRAZYFLIE_INTERFACES__SRV__DETAIL__LAND__FUNCTIONS_H_
 ...
 * calls
 * crazyflie_interfaces__srv__Land_Request__init().
...
/**
 * It calls
 * crazyflie_interfaces__srv__Land_Request__fini()
 ...
 * crazyflie_interfaces__srv__Land_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * crazyflie_interfaces__srv__Land_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__Land_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__Land_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It allocates the memory for the array and calls
 * crazyflie_interfaces__srv__Land_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__Land_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CRAZYFLIE_INTERFACES__SRV__DETAIL__LAND__FUNCTIONS_H_
