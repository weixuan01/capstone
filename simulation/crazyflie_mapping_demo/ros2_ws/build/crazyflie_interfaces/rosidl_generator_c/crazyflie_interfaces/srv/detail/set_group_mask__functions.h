...
#ifndef CRAZYFLIE_INTERFACES__SRV__DETAIL__SET_GROUP_MASK__FUNCTIONS_H_
#define CRAZYFLIE_INTERFACES__SRV__DETAIL__SET_GROUP_MASK__FUNCTIONS_H_
...
/// Initialize srv/SetGroupMask message.
/**
 ...
 * )) before or use
 * crazyflie_interfaces__srv__SetGroupMask_Request__create()
...
/// Finalize srv/SetGroupMask message.
/**
...
/// Create srv/SetGroupMask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__SetGroupMask_Request__init().
...
/// Destroy srv/SetGroupMask message.
/**
 * It calls
 * crazyflie_interfaces__srv__SetGroupMask_Request__fini()
...
/// Check for srv/SetGroupMask message equality.
/**
...
/// Copy a srv/SetGroupMask message.
/**
...
/// Initialize array of srv/SetGroupMask messages.
/**
...
/// Finalize array of srv/SetGroupMask messages.
/**
 * It calls
 * crazyflie_interfaces__srv__SetGroupMask_Request__fini()
...
/// Create array of srv/SetGroupMask messages.
/**
...
/// Destroy array of srv/SetGroupMask messages.
/**
 * It calls
 * crazyflie_interfaces__srv__SetGroupMask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetGroupMask message array equality.
/**
...
/// Copy an array of srv/SetGroupMask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * crazyflie_interfaces__srv__SetGroupMask_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__SetGroupMask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__SetGroupMask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__SetGroupMask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CRAZYFLIE_INTERFACES__SRV__DETAIL__SET_GROUP_MASK__FUNCTIONS_H_
