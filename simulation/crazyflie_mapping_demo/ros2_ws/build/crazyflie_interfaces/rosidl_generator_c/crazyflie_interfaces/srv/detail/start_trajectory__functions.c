...
crazyflie_interfaces__srv__StartTrajectory_Request__create()
{
  ...
  crazyflie_interfaces__srv__StartTrajectory_Request * msg = (crazyflie_interfaces__srv__StartTrajectory_Request *)allocator.allocate(sizeof(crazyflie_interfaces__srv__StartTrajectory_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__srv__StartTrajectory_Request__Sequence__init(crazyflie_interfaces__srv__StartTrajectory_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__srv__StartTrajectory_Request *)allocator.zero_allocate(size, sizeof(crazyflie_interfaces__srv__StartTrajectory_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__StartTrajectory_Request__Sequence * array = (crazyflie_interfaces__srv__StartTrajectory_Request__Sequence *)allocator.allocate(sizeof(crazyflie_interfaces__srv__StartTrajectory_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__srv__StartTrajectory_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__srv__StartTrajectory_Request * data =
      (crazyflie_interfaces__srv__StartTrajectory_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__srv__StartTrajectory_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__srv__StartTrajectory_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__StartTrajectory_Response * msg = (crazyflie_interfaces__srv__StartTrajectory_Response *)allocator.allocate(sizeof(crazyflie_interfaces__srv__StartTrajectory_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__srv__StartTrajectory_Response__Sequence__init(crazyflie_interfaces__srv__StartTrajectory_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__srv__StartTrajectory_Response *)allocator.zero_allocate(size, sizeof(crazyflie_interfaces__srv__StartTrajectory_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__StartTrajectory_Response__Sequence * array = (crazyflie_interfaces__srv__StartTrajectory_Response__Sequence *)allocator.allocate(sizeof(crazyflie_interfaces__srv__StartTrajectory_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__srv__StartTrajectory_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__srv__StartTrajectory_Response * data =
      (crazyflie_interfaces__srv__StartTrajectory_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__srv__StartTrajectory_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__srv__StartTrajectory_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
