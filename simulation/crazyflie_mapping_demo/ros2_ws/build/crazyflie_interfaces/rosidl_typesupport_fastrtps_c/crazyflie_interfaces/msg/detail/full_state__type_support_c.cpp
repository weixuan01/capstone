...
#include "crazyflie_interfaces/msg/detail/full_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acc
...
using _FullState__ros_msg_type = crazyflie_interfaces__msg__FullState;
...
size_t get_serialized_size_crazyflie_interfaces__msg__FullState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FullState__ros_msg_type * ros_message = static_cast<const _FullState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _FullState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_interfaces__msg__FullState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_crazyflie_interfaces__msg__FullState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces__msg__FullState;
    is_plain =
      (
...
static size_t _FullState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__msg__FullState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, msg, FullState)() {
