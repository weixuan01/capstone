...
#include "crazyflie_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
using _Position__ros_msg_type = crazyflie_interfaces__msg__Position;
...
size_t get_serialized_size_crazyflie_interfaces__msg__Position(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Position__ros_msg_type * ros_message = static_cast<const _Position__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_interfaces__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_crazyflie_interfaces__msg__Position(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces__msg__Position;
    is_plain =
      (
...
static size_t _Position__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__msg__Position(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, msg, Position)() {
