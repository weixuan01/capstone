  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces__srv__GoTo_Request;
    is_plain =
      (
...
static size_t _GoTo_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__srv__GoTo_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = crazyflie_interfaces__srv__GoTo_Response;
    is_plain =
      (
...
static size_t _GoTo_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__srv__GoTo_Response(
    full_bounded, is_plain, 0);
