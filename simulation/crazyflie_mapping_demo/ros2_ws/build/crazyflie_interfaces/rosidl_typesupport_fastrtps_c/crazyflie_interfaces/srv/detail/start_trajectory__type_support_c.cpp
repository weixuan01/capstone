...
#include "crazyflie_interfaces/srv/detail/start_trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _StartTrajectory_Request__ros_msg_type = crazyflie_interfaces__srv__StartTrajectory_Request;
...
size_t get_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Request(
  const void * untyped_ros_message,
...
static uint32_t _StartTrajectory_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces__srv__StartTrajectory_Request;
    is_plain =
      (
...
static size_t _StartTrajectory_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, srv, StartTrajectory_Request)() {
...
using _StartTrajectory_Response__ros_msg_type = crazyflie_interfaces__srv__StartTrajectory_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t get_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartTrajectory_Response__ros_msg_type * ros_message = static_cast<const _StartTrajectory_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = crazyflie_interfaces__srv__StartTrajectory_Response;
    is_plain =
      (
...
static size_t _StartTrajectory_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, srv, StartTrajectory_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, srv, StartTrajectory)() {
