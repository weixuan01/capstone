...
{
  new (message_memory) crazyflie_interfaces::srv::Stop_Request(_init);
}

void Stop_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<crazyflie_interfaces::srv::Stop_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Stop_Request_message_member_array[1] = {
  {
    ...
    offsetof(crazyflie_interfaces::srv::Stop_Request, group_mask),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stop_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(crazyflie_interfaces::srv::Stop_Request),
...
{
  return &::crazyflie_interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, srv, Stop_Request)() {
  return &::crazyflie_interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Request_message_type_support_handle;
}
...
void Stop_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) crazyflie_interfaces::srv::Stop_Response(_init);
}

void Stop_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<crazyflie_interfaces::srv::Stop_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Stop_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(crazyflie_interfaces::srv::Stop_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stop_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(crazyflie_interfaces::srv::Stop_Response),
...
{
  return &::crazyflie_interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, srv, Stop_Response)() {
  return &::crazyflie_interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Stop_service_members = {
  ...
  // see get_service_type_support_handle<crazyflie_interfaces::srv::Stop>()
...
get_service_type_support_handle<crazyflie_interfaces::srv::Stop>()
{
  ...
  auto service_type_support =
    &::crazyflie_interfaces::srv::rosidl_typesupport_introspection_cpp::Stop_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::crazyflie_interfaces::srv::Stop_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::crazyflie_interfaces::srv::Stop_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, srv, Stop)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<crazyflie_interfaces::srv::Stop>();
}
