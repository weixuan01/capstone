...
static const _TrajectoryPolynomialPiece_type_support_symbol_names_t _TrajectoryPolynomialPiece_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, msg, TrajectoryPolynomialPiece)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, msg, TrajectoryPolynomialPiece)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, crazyflie_interfaces, msg, TrajectoryPolynomialPiece)() {
  return &::crazyflie_interfaces::msg::rosidl_typesupport_c::TrajectoryPolynomialPiece_message_type_support_handle;
}
