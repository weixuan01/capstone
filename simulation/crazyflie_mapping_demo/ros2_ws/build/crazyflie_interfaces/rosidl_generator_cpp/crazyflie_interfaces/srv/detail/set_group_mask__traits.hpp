...
inline void to_flow_style_yaml(
  const SetGroupMask_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: group_mask
...
inline std::string to_yaml(const SetGroupMask_Request & msg, bool use_flow_style = false)
{
...
inline void to_flow_style_yaml(
  const SetGroupMask_Response & msg,
  std::ostream & out)
{
  (void)msg;
  out << "null";
...
inline std::string to_yaml(const SetGroupMask_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
