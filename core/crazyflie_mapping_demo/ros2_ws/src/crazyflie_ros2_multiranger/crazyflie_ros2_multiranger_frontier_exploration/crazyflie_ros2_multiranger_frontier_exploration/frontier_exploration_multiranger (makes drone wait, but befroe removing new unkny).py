...
PEER_GRADIENT_SCALE_FACTOR   = 0.8  # tuning knob: scale = effective_side * this
PEER_GRADIENT_SCALE_FALLBACK = 2.0  # metres — used before map data arrives
PEER_GRADIENT_WEIGHT         = 20.0   # maximum score bonus/penalty magnitude
